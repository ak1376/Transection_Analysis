...
source_dir_list = [f'{absolute_path}/Dropbox (University of Oregon)/AK_RHV_Analysis/AreaX_lesions/USA5336/wav_files/15/songs']
dest_dir_list = [f'{absolute_path}/Dropbox (University of Oregon)/AK_RHV_Analysis/AreaX_lesions/USA5336/15/Python_Files']

# Initialize the Canary_Analysis object

num_spec = [50] # How many spectrogram from day at position 0, how many spectrogram from day at position 1
