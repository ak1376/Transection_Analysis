# Temporary Fix: My model works very well with the TweetyNet data signal 
# processing scheme. Let's quickly validate my model using the same signal
# processing protocol.

# Ultimately we will want our model to be invariant to the signal processing
# protocol, so long as syllables are clearly shown. 
...
# Usage:
wav_to_spec = WavtoSpec('/home/akapoor/Dropbox (University of Oregon)/USA5207/14/', '/home/akapoor/Desktop/cleaned_rose_data/')
